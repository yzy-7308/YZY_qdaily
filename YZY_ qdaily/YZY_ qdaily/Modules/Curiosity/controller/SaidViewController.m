...
//    flowLayout.minimumLineSpacing = 0;
    ...
    NSLog(@"%@",_yzy.post.myImage);
    [_myImageView sd_setImageWithURL:[NSURL URLWithString:_yzy.post.myImage]];
    ...
    smallLaebl.text = [NSString stringWithFormat:@"%ld", _yzy.post.record_count];
